...
- Cesar Nicolas Camac Melendez

# Video de Youtube: https://youtu.be/zQLZWCTCKsA
...
CREATE TABLE usuarios (
    ...
    tipo_usuario ENUM('deportista', 'administrador', 'propietario'),
...
GET    /api/instalaciones/{id}      # Obtener instalación específica
...
- **Cumplimiento GDPR**: Según Ley N° 29733 de Protección de Datos Personales
...
2. **Error 500 - Internal Server Error**
   ...
   chmod -R 755 /var/www/html/gameon-network
   ```

3. **Google Maps no Funciona**
   ```bash
   # Verificar API key en config/apis.php
   # Comprobar límites de uso en Google Cloud Console
   ```
...
- Capacidad: 10,000+ instalaciones simultáneas
